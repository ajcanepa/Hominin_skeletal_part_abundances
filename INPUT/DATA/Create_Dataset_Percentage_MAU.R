...
# Convert '-' to "nan"
char_cols <- sapply(Summary_Dataset_Multivar_Percentage_MAU, is.character)
Summary_Dataset_Multivar_Percentage_MAU[char_cols] <- lapply(Summary_Dataset_Multivar_Percentage_MAU[char_cols], na_if, '-')

# Convert non-numeric to type tumeric
cols_to_convert <- setdiff(names(Summary_Dataset_Multivar_Percentage_MNAU), c("Type", "AccumulationType", "Individuals"))
Summary_Dataset_Multivar_Percentage_MAU[cols_to_convert] <- lapply(Summary_Dataset_Multivar_Percentage_MAU[cols_to_convert], function(x) {
