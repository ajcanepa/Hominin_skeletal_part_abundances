...
```{r}
data <- read.csv('../Input/DATA/Summary_Dataset_Used_Relative_MNAU.csv')
...
```{R}
list_of_dfs <- list(data, data[, columns_rf_sup], data[, columns_rf], data_cor, X_pca[, 1:6], X_lda)
```
