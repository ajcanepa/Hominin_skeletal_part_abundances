...
2.  Unsupervised data analysis using Clustering methods like
...
4.  Used feature selection methods like MDA (Mean Decrease Accuracy) and
    %IncMSE (Increase in Mean Square Error) to select features, via Random Forrest.
5. Compared results via Silhouette score with Pnas (kmeans 0.71/ dbscan 0.79 / hclust 0.64 vs Pnas 0.57)


## Pnas %MAU vs %MAU

| ![%MAU](%MAU_plot.png) | ![%MNAU](%MNAU_plot.png) |
|---------------------------|-------------------------------|
...
scavenging (refuse vs scat), Unscavenged human corpses plus one Natural Baboon accumulation 
