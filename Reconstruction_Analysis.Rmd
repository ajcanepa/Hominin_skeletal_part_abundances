...
El total de ensambles de primates fue de `r levels(factor(Summary_Dataset$Ref))`. De éstos, se seleccionaron 14 además de los de la sima de los huesos (**SH**) y Dinaledi Chamber (**DC**). Ver los supplemental information para dilucidar los conjuntos de datos "*seleccionados*"
...
# put CSV, XLS, and PDF in a collection
datatable(
  Summary_Dataset_Multivar, width = '100%', 
  #options = list(scrollX = TRUE),
  extensions = 'Buttons', 
  options = list(
   scrollX = TRUE,
